...
#  from expose.data.structures import StructureList, Keypoints2D
...
def keyp_target_to_image(
    img: Array,
    keypoints,
    color_left: Optional[FloatList] = [0.9, 0.0, 0.0],
    color_right: Optional[FloatList] = [0.0, 0.0, 0.9],
    color_else: Optional[FloatList] = [1.0, 1.0, 1.0],
    marker_size: int = 2,
    linewidth: int = 2,
    draw_skel: bool = True,
    draw_text: bool = True,
