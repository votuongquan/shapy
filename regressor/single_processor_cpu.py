...
# Remove OpenGL platform setting for CPU-only usage
...
class SingleImageProcessor:
    ...
    def __init__(self, 
        ...
        # Only check CUDA availability if explicitly requested
        ...
        logger.info(f"SingleImageProcessor initialized successfully on device: {self.device}")
    ...
    def _synchronize_device(self):
        """Synchronize device operations - only for CUDA."""
    ...
    def process_image(self, image_path: str, keypoints_path: str, output_path: str = None) -> str:
        ...
        try:
            ...
            for batch in body_dloader:
                ...
                # Handle faces - they might be tensors too
                ...
                camera_scale = camera_parameters['scale'].detach().cpu()
                camera_transl = camera_parameters['translation'].detach().cpu()
...
if __name__ == '__main__':
    # These settings might help with CPU performance but are mainly for CUDA
